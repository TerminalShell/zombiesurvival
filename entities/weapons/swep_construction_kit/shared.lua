...
if CLIENT then
	...
	surface.CreateFont("12ptFont", {font = "Arial", size = 12, weight = 500, antialias = true, additive = false})
	surface.CreateFont("24ptFont", {font = "Arial", size = 24, weight = 500, antialias = true, additive = false})
	...
	*********************************/
	...
	function SWEP:DrawHUD()
		...
		if (self.Frame and self.Frame:IsVisible()) then
			...
			draw.SimpleTextOutlined(text, "default", ScrW()/2, ScrH()/4, Color(255,255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, Color(20,20,20,255))
	...
	***************************/
	local function CreateMenu( preset )
		...
		tab:AddSheet( "Tool", ptool, "icon16/wrench.png", false, false, "Modify tool settings" )
		tab:AddSheet( "Weapon", pweapon, "icon16/bomb.png", false, false, "Modify weapon settings" )
		tab:AddSheet( "Ironsights", pironsight, "icon16/wrench.png", false, false, "Modify ironsights" )
		tab:AddSheet( "VModels", pmodels, "icon16/brick_add.png", false, false, "Modify view models" )
		tab:AddSheet( "WModels", pwmodels, "icon16/brick_add.png", false, false, "Modify world models" )
		...
		*****************/
		...
		vhbox.OnChange = function()
			...
			if (wep.ShowViewModel) then
				LocalPlayer():GetViewModel():SetColor(color_white)
			else
